...
class Variable(object):
    ...
    def __repr__(self):
        ...
        return '%(class)s(name="%(name)s", value="%(value)s")' % \
            {
...
class Variables(MutableMapping):
    ...
    def __init__(self, manager, info, loaded=False):
        ...
        self._loaded = loaded
        self._info = info
        self._variables_dict = self._to_variables_dict(
            info.get(self._var_key, dict()))
    ...
    def __repr__(self):
        ...
        info = ", ".join("%s=%s" % (k, self._variables_dict[k])
                                    for k, v in self._variables_dict.items())
    ...
    def to_dict(self):
        ...
        return self._info.get(self._var_key)
...
class VariableManager(crud.CRUDClient):
    ...
    def delete(self, *args, **kwargs):
        """Wraps crud.CRUDClient's delete to simplify for the variables.
        ...
        """
        super(VariableManager, self).delete(json=args, **kwargs)
