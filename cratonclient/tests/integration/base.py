...
class BetamaxTestCase(base.TestCase):
    ...
    def setUp(self):
        ...
        self.url = envget('CRATON_URL', 'http://127.0.0.1:8080')
        ...
        # NOTE(sigmavirus24): These defaults are in the tox.ini file and can
        # be overridden.
        self.demo_credentials = {
            'username': envget('CRATON_DEMO_USERNAME'),
            'token': envget('CRATON_DEMO_TOKEN'),
            'project': envget('CRATON_DEMO_PROJECT'),
        }
        self.root_credentials = {
            'username': envget('CRATON_ROOT_USERNAME'),
            'token': envget('CRATON_ROOT_TOKEN'),
            'project': envget('CRATON_ROOT_PROJECT'),
        }
