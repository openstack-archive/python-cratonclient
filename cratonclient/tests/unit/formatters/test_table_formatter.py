...
class TestTableFormatter(base.FormatterTestCase):
    ...
    def test_sort_kwargs(self):
        ...
        self.assertDictEqual(
            {
                'sortby': 'id',
                'sort_key': self.formatter._default_sort_key,
            },
        ...
        self.formatter.sort_key = mock_sort_key
        self.assertDictEqual(
            {
                'sortby': 'id',
    ...
    def test_default_sort_key(self):
        """Verify _default_sort_key sorts lists with None and another type."""
        unsorted_list = [
            [2, 2],
            [None, 1],
            [1, 1],
        ...
        self.assertEqual(
            sorted_list,
            sorted(unsorted_list, key=self.formatter._default_sort_key)
        )
    ...
    def test_handle_generator(self):
        ...
        mocktable.get_string.assert_called_once_with(
            sort_key=self.formatter._default_sort_key, sortby='id'
        )
        self.print_.assert_called_once_with('')
