...
def do_host_list(cc, args):
    ...
    params = {}
    default_fields = ['id', 'name', 'device_type', 'active', 'region_id', 'cell_id']
...
def do_host_get_vars(cc, args):
    """Delete a host that is registered with the Craton service."""
    host = cc.hosts.get(item_id=args.id)
    cliutils.get_and_print_variables(host, args)
