...
def do_region_get_vars(cc, args):
    """Get variables for a region that is registered with the Craton service."""
...
def do_region_set_vars(cc, args):
    """Set variables for a region that is registered with the Craton service."""
    region = cc.regions.get(item_id=args.id)
